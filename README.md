...
Un seul service web Render (`render.yaml` à la racine, plan gratuit), déployé automatiquement à chaque commit sur `main`. Aucune variable d'environnement requise pour l'instant (pas de backend, pas de secret).
